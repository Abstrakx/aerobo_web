...
API_URL = 'http://192.168.222.200:5000/api/detect_qr_code/'
...
while True:
    ...
    cv2.putText(frame, "SISTEM IOT DOOR LOCK AEROBO", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 255), 2, cv2.LINE_AA)
